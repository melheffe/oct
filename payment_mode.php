    ...
    <td height="365"><table width="798" height="372" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="483" valign="top"><!-- InstanceBeginEditable name="Main" -->
          <div align="center">
            <p>&nbsp;<span class="style3">Welcome Mr.(s) <?php echo $nombrecito; ?></span></p>
            <p class="norm">Payment Options :</p>
            <p align="left" class="style3">We in orlandocheaptickets.com care about your comfort and safety at the moment of our purchase, because of this we offer several options to our customers to make the experience simple, and easy.<br />
              <br />
            </p>
            <form id="form2" name="form1" action="" target="_self" >
              <table width="386" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="191" class="style3"><div align="center"><strong><em>Select one Payment options</em></strong></div></td>
                  <td width="195"><select name="go" id="go" onchange="this.form.action=this.value; this.form.submit()">
                      <option value="#" selected="selected"></option>
                      <option value="mail_order.php">Mail Order</option>
                      <option value="order_payment_cc.php">Credit Card</option>
                    </select>                  </td>
                </tr>
              </table>
              <div align="left"><br />
                <br />
                  <span class="style3">You can choose one of the options above in order to complete the order, and if is required please fill the forms completely to avoid a delay in the process. for any aditional information you can check the support documentation, write us anytime if you have any doubt at <a href="mailto:cs@orlandocheaptickets.com">cs@orlandocheaptickets.com</a> </span>                </div>
            </form>
            <p class="gray_tits">Thanks for preferring us. You’re welcome back anytime</p>
            <p class="gray_tits">&nbsp;</p>
          </div>
