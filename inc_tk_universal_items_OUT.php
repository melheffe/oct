...
$qsa="SELECT * FROM tk_universal_items WHERE id_tk = $id_tk";
...
<td width="191" class="style3">- <?=$fila['nombre_pds']?></td>
    <td width="51" class="style3"><div align="center"><a href="add_parks_to_combo.php?id_tk=<?=$id_tk?>&id_pds=<?=$fila['id_pds']?>">Add</a></div></td>
</tr>
<?php }}?>
</table>	
