    ...
    <td valign="top"><table width="675" height="84" border="0" align="center">
      ...
      <tr>
        <td width="676" height="21"><!-- InstanceBeginEditable name="Titulo" -->
          <div align="center" class="style3">List of Tickets Categories</div>
...
while($row=mysql_fetch_array($sql_exec)){?>
            <tr class="style3">
              ...
              <td><div align="center"><span class="style4"><?php echo "<a href='edita_tc.php?id_tc=".$row['id_tc']."'>Edit</a>"; ?> / <?php echo "<a href='borra_tc.php?id_tc=".$row['Id_tc']."'>Erase</a>"; ?> </span></div></td>
            </tr>
            <?php }?>
          </table>
          <p>&nbsp;</p>
