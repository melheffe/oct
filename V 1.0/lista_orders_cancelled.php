...
$sql="SELECT * FROM orders WHERE status = 4 ORDER BY order_num ";
  ...
  <tr>
    <td width="661" height="242"><table width="400" border="0" align="center" cellpadding="0" cellspacing="0" class="text">
      ...
      <table width="473" height="16" border="0" align="center" cellpadding="0" cellspacing="0" class="text">
        <tr>
          <td width="10">&nbsp;</td>
          <td width="690" class="titulos"><div align="center"><span class="style3">List Cancelled orders</span></div></td>
        </tr>
      </table>
      <br />
      <table width="652" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#EBEBEB" class="text">
        ...
        <tr class="style3">
          ...
          <td><div align="center"><span class="style101"><?php echo "<a href='order_review.php?id_order=".$row['id_order']."' target='_blank'>Preview</a>"; ?></span></div></td>
          </tr>
        <?php }?>
      </table>
      <p>&nbsp;</p></td>
