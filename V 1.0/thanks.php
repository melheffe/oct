    ...
    <td height="365"><table width="798" height="372" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="483" valign="top"><!-- InstanceBeginEditable name="Main" -->
          <p align="center" class="gray_tits">
            Thanks for choosing orlandocheaptickets!!</p>
          <p align="center" class="style3">Now you are part of the family and can surf the website as you wish, enjoing best customer service ans the best prices.</p>
          <p align="center" class="style3">Check out our featured combos and our housing oportunitues.</p>
          <p align="center" class="style3">&nbsp;</p>
          <p align="center" class="gray_tits">Welcome one more time!</p>
          <p class="gray_tits">&nbsp;          </p>
