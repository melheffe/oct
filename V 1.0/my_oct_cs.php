...
if (isset($_POST['enviar'])){
		...
		$errores = array();
			...
			$headers ="From: cs@orlandocheaptickets.com.com\r\n";
			$headers .= "MIME-Version: 1.0\r\n";
			$headers .= "Content-type: text/html; charset=windows-1253\r\n";
			$subject ="Customer Service Orlandocheaptickets.com";
			
			$data = "<p></p>
			<p>Your ticket has been processed successfuly, now you can log in and proceed with your experience.</p>
      ...
      <tr>
        ...
        <td width="656" height="32" valign="top"><!-- InstanceBeginEditable name="Space" -->
          <form id="form1" name="form1" method="post" action="">
            <p class="gray_tits">Customer Service Ticket</p>
            <p>&nbsp;</p>
            <table width="476" border="0" align="center">
              <tr>
                <td width="80" class="style3">Subject</td>
                <td width="386"><label>
                  <input type="text" name="subject" id="subject" />
                </label></td>
              </tr>
              <tr>
                <td class="style3">Order #</td>
                <td><label>
                  <input type="text" name="order" id="order" />
                </label></td>
              </tr>
              <tr>
                <td class="style3">Comments</td>
                <td><label>
