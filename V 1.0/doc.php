    ...
    <td height="365"><table width="798" height="372" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="483" valign="top"><!-- InstanceBeginEditable name="Main" -->
          <table width="468" height="42" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="459" height="18" class="norm"><blockquote>
                <p><?php echo $doc_tit; ?></p>
              </blockquote></td>
            </tr>
            <tr>
              <td class="style3"><?php echo nl2br($doc_cont); ?></td>
            </tr>
          </table>
