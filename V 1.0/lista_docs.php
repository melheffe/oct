...
$sql="SELECT * FROM docs ORDER BY id_doc ";
  ...
  <tr>
    <td width="610" height="242"><table width="400" border="0" align="center" cellpadding="0" cellspacing="0" class="text">
      ...
      <table width="473" height="16" border="0" align="center" cellpadding="0" cellspacing="0" class="text">
        <tr>
          <td width="10">&nbsp;</td>
          <td width="690" class="titulos"><div align="center"><span class="style3">List of Documents</span></div></td>
        </tr>
      </table>
      <br />
      <table width="536" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="537"><table width="693" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#EBEBEB" class="text">
              <tr class="norm">
                <td width="135"><div align="center" class="style3"><strong>Name PDS</strong></div></td>
                <td width="435"><div align="center"><span class="style3 style1 style2"><strong>Description</strong></span></div></td>
                </tr>
              ...
              <tr class="style3">
                ...
                <td class="style4"><span class="style3 style100"><?php echo substr($row['doc_cont'], 0, 150);?></span>...</td>
                <td width="115"><div align="center" class="style3 style100"><span class="style101"><?php echo "<a href='edita_doc.php?id_doc=".$row['id_doc']."'>Edit</a>"; ?> / <?php echo "<a href='borra_doc.php?id_doc=".$row['id_doc']."'>Erase</a>"; ?> </span></div></td>
                </tr>
              <?php }?>
          </table></td>
        </tr>
