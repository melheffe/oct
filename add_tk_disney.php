...
if (isset($_POST['enviar'])){
	...
	header("Location: add_tk_disney_2nd.php?id_tk=$mesmo");
	exit();
            ...
            <tr>
              <td width="501"><form id="form1" name="form1" method="post" action="">
                ...
                <table width="496" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="178" class="style3"><div align="center">Ticket Name:</div></td>
                    <td width="318"><label>
                      <input type="text" name="nombre_tk_disney" id="nombre_tk_disney" />
                    </label></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td class="style3"><div align="center">Gate Price Base ticket:</div></td>
                    <td><label>
                      <input type="text" name="gate" id="gate" />
                    </label></td>
                  </tr>
                  <tr>
                    <td class="style3"><div align="center">Base Ticket Price: </div></td>
                    <td><label>
                      <input type="text" name="our" id="our" />
                    </label></td>
                  </tr>
                  <tr>
                    <td class="style3"><div align="center">Park Hopper&reg; option</div></td>
                    <td><label>
                      <input type="text" name="hopper" id="hopper" />
                    </label></td>
                  </tr>
                  <tr>
                    <td class="style3"><div align="center">Water Park Fun &amp; More option</div></td>
                    <td><label>
                      <input type="text" name="wpfm" id="wpfm" />
                    </label></td>
                  </tr>
                  <tr>
                    <td class="style3"><div align="center">No Expiration</div></td>
                    <td><label>
                  ...
                  <tr>
                    ...
                    <td><input name="status" type="checkbox" id="status" value="1" /></td>
                  </tr>
