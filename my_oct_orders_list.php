...
$sql="SELECT * FROM orders WHERE status != 3  AND Id_customer = $val ORDER BY order_num AND date ASC";
        ...
        <td width="656" height="32" valign="top"><!-- InstanceBeginEditable name="Space" -->
          <div align="center" class="norm">
            ...
            <table width="473" height="16" border="0" align="center" cellpadding="0" cellspacing="0" class="text">
              <tr>
                <td width="10">&nbsp;</td>
                <td width="690" class="titulos"><div align="center" class="gray_tits">Current  Orders</div></td>
              </tr>
            </table>
            <br />
            <table width="458" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#EBEBEB" class="text">
              ...
              <tr class="style3">
                ...
                <td width="61"><div align="center"><span class="style101"><?php echo "<a href='order_review.php?id_order=".$row['id_order']."' target='_blank'>Preview</a>"; ?></span></div></td>
              </tr>
              <?php }?>
            </table>
            <p></p>
