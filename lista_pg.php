...
$sql="SELECT * FROM pg ORDER BY rank DESC";
    ...
    <td valign="top"><table width="675" height="84" border="0" align="center">
      ...
      <tr>
        <td height="400" valign="top"><!-- InstanceBeginEditable name="Editable" -->
          ...
          <br />
          <table width="443" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#EBEBEB" class="text">
            <tr class="text2">
              <td width="32" height="19"><div align="center" class="style3 style4">
                  <div align="center">Id </div>
              </div></td>
              <td width="225"><div align="center" class="style3 style5">
                <div align="center">Group Name </div>
              </div></td>
              <td width="76" class="style3"><div align="center">Rank</div></td>
              <td width="100" class="style3"><div align="center"><strong>Edit / Erase</strong></div></td>
            </tr>
            <?php
