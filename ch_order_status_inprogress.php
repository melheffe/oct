...
$errores = array();
				...
				status = '2' WHERE id_order=".$id_order;
				mysql_query($sql);
        ...
        <td height="400" valign="top"><!-- InstanceBeginEditable name="Editable" -->
          <form id="form1" name="form1" method="post" action="">
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="121" height="24" class="style3">Nuevo Status </td>
                <td width="479" class="style3"><strong>En Proceso</strong></td>
              </tr>
              <tr>
                <td height="92" class="style3">Comentario (*)</td>
