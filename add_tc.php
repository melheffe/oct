...
if (isset($_POST['enviar'])){
	...
	$query = "INSERT INTO tc SET
	name = '$nombre_tc'";
			
	mysql_query($query);
	$msj="Ticket's Category creation completed!";
	}
    ...
    <td valign="top"><table width="675" height="84" border="0" align="center">
      ...
      <tr>
        <td width="676" height="21"><!-- InstanceBeginEditable name="Titulo" -->
          <div align="center" class="orange">Add Ticket's Categories</div>
          ...
          <form id="form1" name="form1" method="post" action="">
            ...
            <table width="228" border="0" align="center">
              <tr>
                ...
                <td width="230"><label>
                  <input type="text" name="nombre_tc" id="nombre_tc" />
                </label></td>
              </tr>
              <tr>
