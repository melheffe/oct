          ...
          <td width="537"><table width="847" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#EBEBEB" class="text">
              ...
              <tr class="style3">
                <td width="143" height="22" class="style4"><div align="center" class="style3">
                    <div align="left">
                      <?php 	$sqla="SELECT * FROM tk_combo_items INNER JOIN pds ON tk_combo_items.id_pds = pds.id_pds WHERE tk_combo_items.id_tk_combo = ".$row['id_tk_combo'];
                ...
                <td class="style5"><div align="center"><a href="add_tk_combo_2nd.php?id_tk_combo=<?=$row['id_tk_combo']?>">Customize</a></div></td>
                <td width="106"><div align="center" class="style3"><?php echo "<a href='edita_tk_combo.php?id_tk_combo=".$row['id_tk_combo']."'>Edit</a>"; ?> / <?php echo "<a href='borra_tk_combo.php?id_tk_combo=".$row['id_tk_combo']."'>Erase</a>"; ?> </span></div></td>
              </tr>
              <?php }?>
          </table></td>
        </tr>
