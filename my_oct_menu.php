...
if ($status==9) {
$msj="Cancellation Notification was sent to Customer Service. You´ll be confirmed shortly";
}
      ...
      <tr>
        ...
        <td width="656" height="32" valign="top"><!-- InstanceBeginEditable name="Space" -->
          <div align="center" class="norm">
            <p><span class="gray_tits">&nbsp;My OCT Account </span></p>
		...
		echo $msj?>
            ...
            <br />
            <table width="500" border="1" cellpadding="1" cellspacing="2" bordercolor="#CCCCCC">
              <tr>
                <td width="250" height="17"><div align="center" class="style3">
                  <p><a href="my_oct_orders_list.php">Manage my orders</a></p>
                  </div></td>
                <td width="250" class="style3"><div align="center"><a href="pw_exchange.php">Change my password</a></div></td>
              </tr>
              <tr>
                <td height="32" class="style3"><div align="center"><a href="my_oct_orders_history.php">History of orders</a></div></td>
                <td class="style3"><div align="center"><a href="my_oct_cs.php">Contact Customer Services</a></div></td>
              </tr>
            </table>
            <br />
            <br />
            <table width="500" border="1" cellpadding="0" cellspacing="2" bordercolor="#CCCCCC">
              <tr>
                <td width="490" height="33" class="style3"><div align="center"><a href="my_oct_to_cancell.php">Cancell an order</a></div></td>
                </tr>
            </table>
            <br />
          </div>
