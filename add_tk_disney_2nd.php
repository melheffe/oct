    ...
    <td valign="top"><table width="675" height="84" border="0" align="center">
      ...
      <tr>
        <td width="676" height="21"><!-- InstanceBeginEditable name="Titulo" -->
          <div align="center"><span class="norm">Add Disney Ticket Parks</span></div>
      ...
      <tr>
        <td height="400" valign="top"><!-- InstanceBeginEditable name="Editable" -->
          <table width="0" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="535" height="326"><table width="455" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="455" class="style3"><div align="center">
                        <?=$msj?>
                      </div></td>
                    </tr>
                  </table>
                <br />
                  <table width="457" border="0" align="center" cellpadding="0" cellspacing="0" class="letrasform">
                    <tr>
                      <td width="393" class="norm"><div align="center">
                        <?=$nombrecito?>
                      </div></td>
                    </tr>
                  </table>
                <br />
                  <table width="496" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="250" valign="top"><?php include('inc_tk_disney_items_OUT.php');?></td>
                      <td width="10">&nbsp;</td>
                      <td width="242" valign="top"><?php include('inc_tk_disney_items_IN.php');?></td>
                    </tr>
                  </table>
                <br />
                  <p align="center" class="style3"> [ <a href="lista_tk.php">Go back to Ticket  list</a> ] </p></td>
            </tr>
          </table>
        <!-- InstanceEndEditable --></td>
      </tr>
